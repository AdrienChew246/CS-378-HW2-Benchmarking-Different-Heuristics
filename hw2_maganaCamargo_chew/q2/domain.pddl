(define (domain waymo_2_electric_boogaloo-domain)
 (:requirements :strips :typing)
 (:types waymo_0 location passenger)
 (:predicates 
             (waymo_at ?v - waymo_0 ?l - location)
             (passenger_at ?p - passenger ?l - location)
             (boarding ?p - passenger ?v - waymo_0)
 ...
 (:action pickup
  :parameters ( ?v - waymo_0 ?p - passenger ?l - location)
